    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary salvarMarcacao" style="display:none">Salvar</button>
                <button type="button" class="btn btn-info btn_medicoes" style="display:none">Medições</button>
