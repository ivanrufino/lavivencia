<div class='col-sm-12 corpo'>
    ...
    <form role="form" action="inserirCliente" method="POST">
                ...
                <div class="col-md-12">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            ...
                            <input  maxlength="15" type="text"   name='CPF' id='CPF' class="form-control" placeholder="Digite o n. do CPF" value="<?php echo set_value('CPF'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <div class='col-md-2'>
                        <div class="form-group">
                            ...
                            <input   type="checkbox" name='COBRE_INTERNACAO' id='COBRE_INTERNACAO' class="form-control" placeholder="" value="S" <?php echo set_checkbox('COBRE_INTERNACAO','S'); ?>/>
                        </div>
                    </div>
                    <div class='col-md-2'>
                        <div class="form-group">
                            <label class="control-label" form="COBRE_REMOCAO">Cobre Remoção</label>
                            <input   type="checkbox" name='COBRE_REMOCAO' id='COBRE_REMOCAO' class="form-control" placeholder="" value="S"<?php echo set_value('COBRE_REMOCAO','S'); ?>/>
                        </div>
                    </div>
                    <div class='col-md-2'>
                        <div class="form-group">
                            <label class="control-label" form="TEMPORARIO">Temporário</label>
                            <input   type="checkbox" name='TEMPORARIO' id='TEMPORARIO' class="form-control" placeholder="" value="S"<?php echo set_value('TEMPORARIO','S'); ?>/>
                        </div>
                    </div>
                    ...
                    <div class='col-md-2'>
                        <div class="form-group">
                            ...
                            <input   type="text" name='QUARTO' id='QUARTO' class="form-control" placeholder="" value="<?php echo set_value('QUARTO'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-2'>
                        <div class="form-group">
                            <label class="control-label">Cama </label>
                            <input   type="text" name='CAMA' id='CAMA' class="form-control" placeholder="" value="<?php echo set_value('CAMA'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            ...
                            <input   type="text" name='ORIGEM' id='ORIGEM' class="form-control" placeholder="" value="<?php echo set_value('ORIGEM'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">Diagnóstico </label>
                            <textarea class='form-control' name='DIAGNOSTICO' id='OBSERVACAO' placeholder="Digite o DIAGNOSTICO"><?php echo set_value('DIAGNOSTICO'); ?> </textarea>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">Nome</label>
                            <input   type="text"  name='nome_contato' id='nome_contato    ' class="form-control" placeholder="Digite o Nome do Contato" value="<?php echo set_value('nome_contato'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">Parentesco</label>
                            <input   type="text"  name='PARENTESCO' id='PARENTESCO    ' class="form-control" placeholder="Digite o Parentesco" value="<?php echo set_value('PARENTESCO'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            ...
                            <input   type="text"  name='REFERENCIAS' id='REFERENCIAS'  class="form-control" placeholder="Digite a REFERENCIAS" value="<?php echo set_value('REFERENCIAS'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">IDENTIDADE</label>
                            <input  maxlength="15" type="text"  name='identidade_contato' id='identidade_contato' class="form-control" placeholder="Digite o n. da IDENTIDADE " value="<?php echo set_value('identidade_contato'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">ORGÃO</label>
                            <input  maxlength="10" type="text"  name='orgao_contato' id='orgao_contato' class="form-control" placeholder="Digite o ORGÃO EMISSOR" value="<?php echo set_value('orgao_contato'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            ...
                            <input  type="text"  name='EMAIL' id='EMAIL' class="form-control" placeholder="Digite o EMAIL" value="<?php echo set_value('EMAIL'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">Data de Nascimento</label>
                            <input  type="text"  name='dt_nascimento_contato' id='dt_nascimento_contato' class="form-control" placeholder="Digite a Data de Nascimento" value="<?php echo set_value('dt_nascimento_contato'); ?>"/>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class='col-md-4'>
                        <div class="form-group">
                            ...
                            <input   type="date"   class="form-control" name='DT_SAIDA' id='DT_SAIDA' placeholder="Digite a Data de Saida" value="<?php echo set_value('DT_SAIDA'); ?>"/>
                        </div>
                    </div>
                    <div class='col-md-4'>
                        <div class="form-group">
                            <label class="control-label">Motivo de Saida</label>
                            <textarea class='form-control' name='MOTIVO_SAIDA' id='MOTIVO_SAIDA' placeholder="Digite o Motivo de Saida"><?php echo set_value('MOTIVO_SAIDA'); ?> </textarea>    
                        </div>
                    </div>
